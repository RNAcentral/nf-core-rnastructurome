...
//
def completionEmail(summary_params, email, email_on_fail, plaintext_email, outdir, monochrome_logs=true, multiqc_report=null, max_multiqc_email_size_input=0) {
    ...
    def max_multiqc_email_size = (max_multiqc_email_size_input ?: 0) as MemoryUnit
