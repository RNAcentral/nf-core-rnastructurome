...
def test_docker_profile_falls_back_to_conda_for_multiqc_on_arm64() -> None:
    ...
    assert "def hostIsArm64 = (System.properties['os.arch'] ?: '').toLowerCase() in ['aarch64', 'arm64']" in config_text
    ...
    assert "container = hostIsArm64 ? null : 'community.wave.seqera.io/library/multiqc:1.32--d58f60e4deb769bf'" in config_text
